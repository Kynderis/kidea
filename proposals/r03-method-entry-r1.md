...
| T01-S02 | Gói quyền hữu hạn, kiểm root trước ghi; nêu Git/AI riêng | IN_REVIEW; [lượt đầu chỉ docs](r03-pilot-permission-r1.md), chưa `.kidea`/Git; ranh giới thiết kế không đổi |
...
| T05-S01 | Chuẩn bị gói kiểm chứng hồ sơ pilot: phiên mới, kịch bản, số lần/thời gian, quyền và log | IN_REVIEW; [gói lượt đầu](r03-pilot-permission-r1.md), chưa chạy, không dùng lại AI r2 |
