...
Đã có [bộ lệnh kiểm chung](../tests/local-portability/README.md), [kết quả Windows/tài liệu](../tests/evidence/local-portability-r1.md) và [kết quả Mac Intel 283/283 trên cùng nguồn](../tests/evidence/local-portability-mac-intel-2026-09-16.md). Phần kiểm host còn lại là chạy cùng bộ trên Apple Silicon thật khi có máy/quyền, không phải xin duyệt lại cách triển khai. Chưa nhận NOT_RUN thành PASS hoặc tự hoàn tất LP-01. R05 tiếp tục từ [gói profile/test](r05-profile-test-r1.md) khi được duyệt đúng phạm vi, không cần chọn lại Docker local hay giải bài toán đồng bộ. Khi cần build/đo nặng mới trình một gói môi trường hữu hạn; không xây hạ tầng chưa có nhu cầu.
