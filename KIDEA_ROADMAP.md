...
**Hiện hành — T04 đã nghiệm thu; T05 vẫn IN_PROGRESS (2026-09-18).** Đã thêm outbox/WSS và Web detail/form quản trị/đăng ký riêng. Backend bốn preset và socket sanitizer PASS trong phạm vi bằng chứng, giữ EX r2 SQLite/WAL cũ; Web81 unit,18 SSR–Chrome Mac PASS. HTTPS/WSS backend thật52/52 PASS trên nguồn cuối (Chromium trong Docker, không bypass TLS), gồm phục hồi/thu hồi phiên và trần socket. [Bằng chứng, FAIL giữ nguyên và việc còn lại](docs/R09_T05_PROGRESS.md). Review nguồn T04 cũ được giữ làm lịch sử; thay đổi T05 mở DRAFT qua public REVISE, chưa Human approval mới/G2/nghiệm thu R09. W-009-ADMIN-OPS IN_PROGRESS, quyền trọn R09 giữ nguyên. Android/iOS Future chưa roadmap, Apple Silicon NOT_RUN; R10 chưa mở. Các ghi chú tiến độ phía dưới là lịch sử.
