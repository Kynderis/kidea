...
**Bản vá Caddy/CEL đã được duyệt, áp dụng và kiểm; E2 còn FAIL header và chờ trần đĩa.** [Lượt r3](tests/evidence/r05/backend-execution-r3.md): Caddy build + 54 leaf matcher tests PASS, Web check/lint/build + 32 unit PASS, C++ dev 9/9 PASS, Node HTTPS subset 33/33 PASS. Header 16385 byte vẫn trả 200 thay vì 431, giữ FAIL; không coi H07/full matrix đạt. TSan probe PASS nhưng full build dừng chủ động khi delta free-space khoảng 15,53 GiB gần trần 16 GiB; chưa browser/release/mutation/full sanitizer trên server mới. [Đề xuất tăng riêng trần đĩa lên 24 GiB](proposals/r05-docker-disk-budget-r1.md) chờ duyệt. Container dừng, port 8443 đóng; không cài host. R05/T03-S03 IN_PROGRESS, Apple Silicon NOT_RUN. Các đoạn dưới là lịch sử.
