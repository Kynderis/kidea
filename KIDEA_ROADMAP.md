...
| LP-01 | IN_PROGRESS | [H] — hướng và triển khai APPROVED sau f8b47b9 | [Gói bổ sung local/đa nền tảng](proposals/local-portability-r1.md): Windows và [Mac Intel 283/283 PASS](tests/evidence/local-portability-mac-intel-2026-09-16.md) trên cùng 36 file; Apple Silicon NOT_RUN. Docker local/cloud chưa cài/chạy; R05 vẫn mở chuẩn bị |

R01–R04 đã APPROVED đúng phạm vi; R04 và R05 có phân rã/evidence được dẫn ở mục phase tương ứng. R05 mở chuẩn bị, LP-01 là gói sửa hiện hành, không thêm phase sản phẩm hoặc nghiệm thu lại R03/R04 từ đầu. Quota launcher T07 cũ vẫn 0/3, AI r2 hết sáu phiên, không chuyển quota. Bằng chứng cũ giữ đúng phiên bản; quyền mới chỉ theo gói hiện hành, không suy ra cài/build/deploy.
...
Đã mở theo approval sau `a72e3a1`. [Phân rã và gói duyệt đầy đủ](proposals/r05-profile-test-r1.md): T01-S01 DONE, T01-S02 IN_REVIEW. [LP-01](proposals/local-portability-r1.md) đã được duyệt riêng sau f8b47b9: host Kidea local Windows/macOS Intel/Apple Silicon, Node ≥24, backend Docker local và cloud khi có host/quyền. Không đồng nghĩa duyệt toàn D1–D6/P1–P4 hoặc bốn profile chưa soạn. Phần mô tả “chưa phân rã” dưới đây là quy tắc trước khi mở phase, nay được cụ thể hóa tại đề xuất; không cấp trước quyền build hoặc duyệt trước kết quả.
