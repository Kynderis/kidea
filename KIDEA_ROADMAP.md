...
| LP-01 | IN_PROGRESS | [H] — hướng và triển khai APPROVED sau f8b47b9 | [Gói bổ sung local/đa nền tảng](proposals/local-portability-r1.md): runtime Node ≥24/Git portable, writer local và hồi quy; Docker local/cloud chỉ đổi phương án, chưa cài/chạy. R05 vẫn mở chuẩn bị; Mac thật NOT_RUN |
