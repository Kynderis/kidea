...
const sources=[...readdirSync(path.join(root,'.agents/skills/kidea/scripts')).map(n=>'.agents/skills/kidea/scripts/'+n),'.agents/skills/kidea/SKILL.md','.agents/skills/kidea/references/init.md','.agents/skills/kidea/references/approve.md','.agents/skills/kidea/references/resume.md',...suites,'tests/r02-t07/run-tests.mjs','tests/fixtures/r02-t04/catalog.mjs','tests/r02-t10/fixtures.mjs','tests/r02-t10/probe.mjs','tests/r02-t10/profile.mjs','package.json','package-lock.json'];
