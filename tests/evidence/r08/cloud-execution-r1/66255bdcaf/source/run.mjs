...
const gc='/usr/local/bin/gcloud',project='kidea-508908',prefix='kidea-r08-c3',network=prefix+'-net',subnet=prefix+'-subnet';
const zoneW='us-central1-a',zoneO='us-central1-c',workload=prefix+'-workload',observer=prefix+'-observer',recovery=prefix+'-recovery';
