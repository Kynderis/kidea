...
| [W-STATE](#state) | [features/admin · flow](../features/admin.md#flow), [features/admin · ac](../features/admin.md#ac), [shared/registration · new](registration.md#new), [tests · access](../tests.md#access), [tests · concurrency](../tests.md#concurrency), [tests · data](../tests.md#data) | Khởi tạo/chuyển state và điều kiện OPEN tại quyết định. |
