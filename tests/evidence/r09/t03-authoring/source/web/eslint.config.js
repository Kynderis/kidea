...
export default [
 ...
 { files:['**/*.svelte'], languageOptions:{ globals:{sessionStorage:'readonly',HTMLDialogElement:'readonly',HTMLButtonElement:'readonly'}, parserOptions:{parser:ts.parser,svelteConfig} } }
];
