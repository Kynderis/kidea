...
Đề xuất đầu ra **bước 6, chờ Human duyệt**. O1–O6 đã được Human “Duyệt thiết kế vận hành R04” sau `86c051ca7968980a25c502e635c5808c8d1eda93`; đó là approval thiết kế, chưa có hệ thống vận hành. [Báo cáo và căn cứ](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/tests/evidence/r04/design-r1.md) giữ trạng thái review, không dùng nhãn trong snapshot thay approval.
...
|---|---|---|
| A1 | Giữ một nhóm trang web quản trị workshop, gồm danh sách, tạo và sửa | Native Future; không thêm quản lý tài khoản, danh tính người tham gia, xóa workshop hoặc hủy hộ |
