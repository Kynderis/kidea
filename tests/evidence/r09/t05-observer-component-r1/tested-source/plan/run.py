...
try:
 ...
 now=int(time.time()*1000);profile={'run':{'id':runid,'operator':'SyntheticFixtureOperator','confirmed':True,'startMs':now,'endMs':now+540000},
 ...
 write(work/'config/observer.json',{'model':profile,'stateDirectory':'/state','sessionsFile':'/control/sessions.json','keyFile':'/config/key.pem',
