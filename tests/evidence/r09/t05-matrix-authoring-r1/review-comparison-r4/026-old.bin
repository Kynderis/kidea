...
| W-DATA/W-EDIT/W-STATE/W-ACCESS | D01–D09 | [Admin AC](features/admin.md#ac) |
...
| D05 | Tạo mới và sửa workshop có sẵn: nhập nội dung HTML `<b>abc</b>` hoặc Markdown `**abc**` vào tiêu đề/mô tả; đối chứng văn bản thuần `Lớp học thủ công` | Hai dạng markup bị từ chối theo W-DATA/B2; tạo không sinh workshop, sửa giữ nguyên nội dung/C/N/state, không event thay đổi. Văn bản thuần thỏa các điều kiện khác được nhận, giữ nghĩa. Không coi lưu literal markup là chấp nhận hợp lệ, không tự đặt bộ lọc dấu câu |
...
| D09 | Admin đủ quyền; chưa có workshop đích. Tạo với title=`Lớp học thủ công`, description=`Buổi thực hành`, C=10, start=2026-10-01T09:00:00+07:00, end=2026-10-01T10:00:00+07:00 | Tạo một ID workshop mới,DRAFT,N=0,C=10 và nội dung/lịch trên; admin đọc được, public không thấy. Thành công cuối chỉ khi kết quả/nghĩa vụ đã chắc, theo [W-STATE](shared/workshop.md#state), [W-ACCESS](shared/workshop.md#access), [V-PUBLISH](shared/availability.md#publish), [AC-A5](features/admin.md#ac). Nhánh dữ liệu sai tại D01/D03–D06 không tạo workshop |
...
| T04 | Cùng case đăng ký/xem trên Web; biến thể Android/iOS Future chưa roadmap; web JS-off cho public list/detail và trang giới thiệu | Cùng nghĩa nghiệp vụ; public nội dung đọc trước JS theo [phạm vi nền tảng](../features.md#boundaries); hiện NOT_RUN vì chưa sản phẩm/thiết bị, không lấy hồ sơ thay bằng chứng |
...
|---|---|---|
| [concurrency](#concurrency) | [Chất lượng · workload](../design/quality.md#workload) | Truy ảnh hưởng sang yêu cầu/case chất lượng; không thay rule nguồn. |
| [coverage](#coverage) | [Chất lượng · coverage](../design/quality.md#coverage) | Truy ảnh hưởng sang yêu cầu/case chất lượng; không thay rule nguồn. |
