...
Căn cứ [B2/B4](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/proposals/r03-completion-batch-r1.md#b-toàn-bộ-quyết-định-nghiệp-vụ-bổ-sung-đề-nghị); invariant từ [D3](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/proposals/r03-registration-decisions-r1.md#d3--đăng-ký-và-sửa-sức-chứa-đồng-thời).
...
Căn cứ [D1](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/proposals/r03-registration-decisions-r1.md#d1--gửi-lại-cùng-yêu-cầu-không-thực-hiện-lần-hai).
...
Căn cứ [D2](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/proposals/r03-registration-decisions-r1.md#d2--thứ-tự-kết-quả-từ-chối-cho-yêu-cầu-mới).
...
Căn cứ [D3](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/proposals/r03-registration-decisions-r1.md#d3--đăng-ký-và-sửa-sức-chứa-đồng-thời).

Hợp đồng dùng trực tiếp: [W-STATE](workshop.md#state) xác định OPEN/PAUSED cho các lịch đăng ký/hủy với PAUSE; [R-INV](#invariant) xác định giới hạn C/N và một ACTIVE phải giữ ở từng kết quả. Đổi chính sách hủy khi PAUSED phải rà lại các kết quả trong mục này.
...
|---|---|---|
| [retry](#retry) | [Chất lượng · response](../../design/quality.md#response), [Chất lượng · recovery](../../design/quality.md#recovery), [Chất lượng · privacy](../../design/quality.md#privacy) | Truy ảnh hưởng sang yêu cầu/case chất lượng; không thay rule nguồn. |
| [invariant](#invariant) | [Chất lượng · recovery](../../design/quality.md#recovery) | Truy ảnh hưởng sang yêu cầu/case chất lượng; không thay rule nguồn. |

### Nơi dùng trong thiết kế trải nghiệm

| Mục nguồn | Nơi dùng | Mục đích |
|---|---|---|
| [retry](#retry) | [Trải nghiệm · action](../../design/experience.md#action) | Truy ảnh hưởng sang UX/SEO; không thay hợp đồng nguồn. |
| [new](#new) | [Trải nghiệm · action](../../design/experience.md#action) | Truy ảnh hưởng sang UX/SEO; không thay hợp đồng nguồn. |
| [invariant](#invariant) | [Trải nghiệm · action](../../design/experience.md#action) | Truy ảnh hưởng sang UX/SEO; không thay hợp đồng nguồn. |
| [serial](#serial) | [Trải nghiệm · action](../../design/experience.md#action) | Truy ảnh hưởng sang UX/SEO; không thay hợp đồng nguồn. |

### Nơi dùng trong thiết kế vận hành

| Mục nguồn | Nơi dùng | Mục đích |
|---|---|---|
| [invariant](#invariant) | [Vận hành · signals](../../design/operations.md#signals) | Truy ảnh hưởng sang thiết kế vận hành; không thay hợp đồng nguồn. |
| [retry](#retry) | [Vận hành · response](../../design/operations.md#response) | Truy ảnh hưởng sang thiết kế vận hành; không thay hợp đồng nguồn. |

### Nơi dùng trong thiết kế quản trị

| Mục nguồn | Nơi dùng | Mục đích |
|---|---|---|
| [invariant](#invariant) | [Quản trị · commands](../../design/admin.md#commands) | Truy ảnh hưởng sang thiết kế quản trị; không thay hợp đồng nguồn. |
| [serial](#serial) | [Quản trị · commands](../../design/admin.md#commands), [Quản trị · confirm](../../design/admin.md#confirm) | Truy ảnh hưởng sang thiết kế quản trị; không thay hợp đồng nguồn. |
| [retry](#retry) | [Quản trị · errors](../../design/admin.md#errors) | Truy ảnh hưởng sang thiết kế quản trị; không thay hợp đồng nguồn. |

### Nơi dùng trong thiết kế kiến trúc

| Mục nguồn | Nơi dùng | Mục đích |
|---|---|---|
| [invariant](#invariant) | [Kiến trúc · storage](../../design/architecture.md#storage) | Truy căn cứ thiết kế AR-r1; không thay nguồn đã duyệt |
| [serial](#serial) | [Kiến trúc · storage](../../design/architecture.md#storage) | Truy căn cứ thiết kế AR-r1; không thay nguồn đã duyệt |
| [new](#new) | [Kiến trúc · storage](../../design/architecture.md#storage) | Truy căn cứ thiết kế AR-r1; không thay nguồn đã duyệt |
| [retry](#retry) | [Kiến trúc · admin-intent](../../design/architecture.md#admin-intent) | Truy căn cứ thiết kế AR-r1; không thay nguồn đã duyệt |

### Nơi dùng bổ sung trong kiến trúc AR-r2 (đề xuất C5)

| Mục nguồn | Nơi dùng | Mục đích |
|---|---|---|
| [retry](#retry) | [Kiến trúc · storage](../../design/architecture.md#storage), [Kiến trúc · api](../../design/architecture.md#api), [Kiến trúc · updates](../../design/architecture.md#updates), [Kiến trúc · admission](../../design/architecture.md#admission), [Kiến trúc · cases](../../design/architecture.md#cases) | Truy hợp đồng trực tiếp và ca sửa review; không đổi nguồn |
