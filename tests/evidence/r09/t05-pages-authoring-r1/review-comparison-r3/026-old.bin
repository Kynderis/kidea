...
Đây là **đề xuất đầu ra bước 3, chờ Human duyệt**, không phải số đo hoặc chứng nhận ứng dụng. Quyền soạn từ [R04-DESIGN-BATCH-r1](https://github.com/Kynderis/kidea/blob/77f5caf404f06315b12bfd8027adc9bb1cbba036/proposals/r04-design-batch-r1.md); phạm vi sản phẩm từ [Feature Map](../features.md#boundaries). Mọi ca dưới đây **NOT_RUN trên sản phẩm**. Việc review/tạo file không làm test ứng dụng đạt.
