...
Profile `workshop-rules-web-r2`, revision 2; phạm vi pilot lab dữ liệu giả, không production. Nguồn chính: [kiến trúc](../design/architecture.md#components), [chất lượng](../design/quality.md#coverage), [nghiệp vụ](../business/tests.md#coverage). Hai profile hiện hành: [C++](cpp.md#rules), [Web](web.md#rules); giữ lịch sử Future chưa roadmap: [Android](android.md#rules), [iOS](ios.md#rules); [đặc tả kiểm](tests.md#protocol).
