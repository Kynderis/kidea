...
| Mục nguồn | Nơi dùng | Mục đích |
|---|---|---|
| [flow](#flow) | [Quản trị · scope](../../design/admin.md#scope) | Truy ảnh hưởng sang thiết kế quản trị; không thay hợp đồng nguồn. |
| [ac](#ac) | [Quản trị · commands](../../design/admin.md#commands) | Truy ảnh hưởng sang thiết kế quản trị; không thay hợp đồng nguồn. |
