...
| N1 danh sách Android/iOS | Tất cả/Của tôi; Tất cả cùng W1, Của tôi cùng W3 sau kiểm quyền | Bộ lọc trên cùng màn hình; trở về từ N2 giữ bộ lọc/vị trí khi dữ liệu còn hợp lệ |
| N2 chi tiết Android/iOS | Cùng nội dung/nghĩa với W2, vùng lịch sử của tôi khi hợp lệ; thao tác cùng U-ACTION | Không thêm admin/ops native; back tới N1, không tự gửi lại thao tác do điều hướng |
...
Đây là bố cục và thông tin, không chốt framework/component hoặc dựng dashboard. Web rộng dùng vùng điều hướng và cột nội dung; web hẹp/native một cột, nội dung dài xuống dòng, không cắt mất timezone/trạng thái hoặc nút chính. Không thêm ảnh/logo/asset lớn khi bài mẫu không có nguồn ảnh.
...
- Bố cục kiểm ở bề rộng 360 và 1280 CSS px, thêm phóng chữ 200% trên web; không mất nội dung/nút chính hoặc buộc cuộn ngang toàn trang. Native dùng cỡ chữ hệ thống lớn theo profile thiết bị R05. Đây là phạm vi kiểm đề xuất của UX6, không chứng nhận chuẩn pháp lý/accessibility toàn diện.
...
| UX-T02 | Từng W1/W3/N1: loading → empty hợp lệ, rồi lỗi mạng/quyền | Phân biệt bốn trạng thái; [U-SCREENS](#screens), [U-ERROR](#error) |
...
| UX-T10 | Bàn phím, focus dialog/field, 360/1280 px, chữ 200%, chữ native lớn | Hoàn thành luồng chính không mắc kẹt/mất nút/nhãn; [U-USABILITY](#usability) |
...
| UX-T13 | Cùng hành trình web/Android/iOS, N1 Tất cả/Của tôi → N2 → back | Cùng rule/identity, giữ navigation không mutation; không admin native; [U-SCREENS](#screens) |
