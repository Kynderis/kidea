...
Đây là amendment hồ sơ, chưa cài/build/chạy Docker, kết nối cloud, diễn tập hoặc đo native; toàn bộ kết quả ứng dụng vẫn **NOT_RUN**. Không biến thiếu máy thành N/A hoặc giảm yêu cầu Mac/iPhone/Android thật của phần tương ứng.
