...
private:
  sqlite3 *db_{};
  // This synthetic backend has one process-wide SQLite writer authority.
  // Separate Store handles must not bypass it. Recursive only for constructor
  // initialization calling the public, guarded pragma reader.
