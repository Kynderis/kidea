...
export default [
 ...
 { files:['**/*.svelte'], languageOptions:{ globals:{crypto:'readonly',sessionStorage:'readonly',HTMLDialogElement:'readonly',HTMLButtonElement:'readonly'}, parserOptions:{parser:ts.parser,svelteConfig} } }
];
