...
export default defineConfig({
 ...
 webServer:{command:`"${process.execPath}" build/index.js`,url:'http://127.0.0.1:4173',reuseExistingServer:false,timeout:15000,env:{HOST:'127.0.0.1',PORT:'4173',ORIGIN:'http://127.0.0.1:4173',BODY_SIZE_LIMIT:'131072',SHUTDOWN_TIMEOUT:'30'}}
});
