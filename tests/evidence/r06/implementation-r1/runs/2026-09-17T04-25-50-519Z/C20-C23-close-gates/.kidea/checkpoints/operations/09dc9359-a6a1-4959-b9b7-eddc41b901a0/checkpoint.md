...
```json
{
  ...
  "kind": "checkpoint",
  "id": "09dc9359-a6a1-4959-b9b7-eddc41b901a0",
  "ownerId": "impact-955cca1ceba45052d85984d3",
  "createdAt": "2026-09-17T04:26:57.630Z",
  "tool": {
  ...
  "permissionRefs": [
    {
      "source": {
        "path": ".kidea/reviews/evidence/R06-fixture-09dc9359-a6a1-4959-b9b7-eddc41b901a0-0.md",
        "anchor": null
      },
      "location": {
        "kind": "SNAPSHOT",
  ...
  "inputRefs": [
    {
      "source": {
        "path": ".kidea/reviews/evidence/R06-fixture-09dc9359-a6a1-4959-b9b7-eddc41b901a0-1.md",
        "anchor": null
      },
      "location": {
        "kind": "SNAPSHOT",
      ...
      "integrity": {
        "method": "SHA256",
        "value": "26fb9bb2903a1f55682179cacba96bd42b56ef71992a7fbdaff5d28c40d9652e",
        "byteLength": 387
      }
    }
  ],
  "targets": [
      ...
      "planned": {
        "version": {
          ...
          "location": {
            "kind": "SNAPSHOT",
            "ref": {
              "path": ".kidea/checkpoints/operations/09dc9359-a6a1-4959-b9b7-eddc41b901a0/planned-0.bin",
              "anchor": null
            }
          },
          "integrity": {
      ...
      "planned": {
        "version": {
          ...
          "location": {
            "kind": "SNAPSHOT",
            "ref": {
              "path": ".kidea/checkpoints/operations/09dc9359-a6a1-4959-b9b7-eddc41b901a0/planned-1.bin",
              "anchor": null
            }
          },
          "integrity": {
    ...
    {
      "path": ".kidea/reviews/evidence/R06-fixture-09dc9359-a6a1-4959-b9b7-eddc41b901a0-2.md",
      "action": "CREATE",
      "before": null,
      "planned": {
        "version": {
          ...
          "location": {
            "kind": "SNAPSHOT",
            "ref": {
              "path": ".kidea/checkpoints/operations/09dc9359-a6a1-4959-b9b7-eddc41b901a0/planned-2.bin",
              "anchor": null
            }
          },
          "integrity": {
      ...
      "planned": {
        "version": {
          ...
          "location": {
            "kind": "SNAPSHOT",
            "ref": {
              "path": ".kidea/checkpoints/operations/09dc9359-a6a1-4959-b9b7-eddc41b901a0/planned-3.bin",
              "anchor": null
            }
          },
          "integrity": {
      ...
      "before": {
        "version": {
          ...
          "location": {
            "kind": "SNAPSHOT",
            "ref": {
              "path": ".kidea/checkpoints/operations/09dc9359-a6a1-4959-b9b7-eddc41b901a0/before-4.bin",
              "anchor": null
            }
          },
          "integrity": {
      ...
      "planned": {
        "version": {
          ...
          "location": {
            "kind": "SNAPSHOT",
            "ref": {
              "path": ".kidea/checkpoints/operations/09dc9359-a6a1-4959-b9b7-eddc41b901a0/planned-4.bin",
              "anchor": null
            }
          },
          "integrity": {
