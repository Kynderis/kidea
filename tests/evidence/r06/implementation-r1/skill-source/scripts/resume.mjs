...
import {resumeImpactContext} from './impact.mjs';
...
function inspect(root,request,{beforeRecheck}={}) {
  ...
  const impact=resumeImpactContext(items,reads);
  if(impact.some(i=>!i.current||i.verdict==='UNKNOWN'))attention.push('IMPACT_REVIEW_REQUIRED');
