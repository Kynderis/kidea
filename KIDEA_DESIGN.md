...
<a id="client-web-scope-approved"></a>

**Điều chỉnh phạm vi đã được Human quyết định ngày 2026-09-17:** Kidea hiện hỗ trợ phát triển client **Web**; hỗ trợ app Android/iOS chuyển thành **Future, chưa có roadmap hoặc thời hạn**. Dừng chuẩn bị/build/runtime/cài SDK/Xcode/signing native. Các cam kết native bản đầu, task và điều kiện nghiệm thu native trong tài liệu trước quyết định này không còn áp dụng cho phạm vi hiện hành; giữ chúng để truy lịch sử, không chuyển kết quả FAIL/NOT_RUN thành PASS hoặc coi việc hoãn là đã hoàn thành.
...
Ngày 2026-09-15, Human yêu cầu gom các xác nhận đã biết trước khi chạy, sau đó thực hiện một lượt liền mạch trong phạm vi đã đồng ý; chỉ dừng hỏi khi phát sinh quyền hoặc quyết định mới thực sự cần Human. Không chia nhỏ việc thường lệ thành nhiều lượt xin phép. Human đồng ý bài thử chức năng trên project giả ở D, không dựng VM hoặc thay tài khoản/quyền Windows/firewall; không coi đó là chứng nhận cách ly hệ điều hành hay tự động nghiệm thu toàn bộ Kidea.

Human nhắc lại sau gói rule đăng ký và xác nhận “đúng, làm đi. Và kể cả các gói sau này cũng nên làm thế”: áp dụng **duyệt theo gói đầy đủ cho mọi phase/gói xây Kidea tiếp theo**. Rà trước toàn phần việc gần nhất, gom quyết định mới, quyền và loạt kiểm chứng thành danh sách hữu hạn có đề xuất/ví dụ; Human có thể duyệt cả gói hoặc sửa từng mục. Không cắt thành nhiều lượt chỉ để giữ giới hạn 2–3 ý. Sau approval làm liên tục phần thường lệ; chỉ hỏi thêm khi phát sinh lựa chọn/quyền mới thực sự hoặc gate kết quả chưa có căn cứ trước khi chạy. Giữ traceability và ranh giới approval, không coi duyệt kế hoạch là duyệt trước sản phẩm chưa tạo. Quy tắc này thay các giới hạn chia lượt cũ nếu chúng gây hỏi lắt nhắt; không tự đổi Human gate của sản phẩm được Kidea quản lý.
...
- Một Human + AI, đúng một lượt Kidea có quyền sửa trên cùng project tại một thời điểm, kể cả qua cửa sổ/máy khác. Human chờ lượt hoàn tất; mọi thay đổi tài liệu/code đi qua Kidea. Helper, formatter, build sinh nguồn, Git và agent có quyền ghi chạy tuần tự; không có editor, tiến trình đồng bộ hoặc writer ngoài luồng đang sửa project. Đây là điều kiện sử dụng, không phải lời hứa khóa hệ điều hành chặn mọi chương trình khác.
...
- Human đã điều chỉnh định hướng host ngày 2026-09-16: Kidea dùng một bộ code/lệnh/hồ sơ chung trên Windows, macOS Intel và Apple Silicon, chỉ trong thư mục local; [hợp đồng hiện hành](#local-portability-approved). Backend sản phẩm vẫn C++20/Ubuntu nhưng build/chạy thường ngày bằng Docker local, test nặng/hiệu năng trên cloud khi có máy và quyền; client Web giữ SEO và hiệu năng; Android/iOS Future, chưa roadmap. Đây là yêu cầu đích, không phải tuyên bố mọi host/toolchain đã kiểm chứng. Runtime thuộc R02 và gói bổ sung local; profile rule thuộc R05, bản đồ thuộc R06.
...
- Thư mục mạng, cây đang đồng bộ iCloud/OneDrive và nhiều máy cùng ghi không thuộc phạm vi hỗ trợ Kidea, không phải cam kết sẽ xây sau. Chỉ dùng bản làm việc local độc lập, một writer tại một thời điểm; chuyển máy tuần tự qua Git không phải đồng bộ nhiều writer. Không tự di chuyển thư mục hay tắt dịch vụ đồng bộ của Human.
...
Human đồng ý với ba nhóm ưu tiên và thứ tự trong câu trả lời ngày 2026-09-10; [căn cứ đúng bản và kết quả đồng bộ](KIDEA_ROADMAP.md#production-scope-result). Kidea phải quản lý toàn chuỗi từ bản đầu, nhưng chỉ công bố thực thi trên tổ hợp đã chọn và kiểm chứng. Phần đã có được cụ thể hóa, không bỏ mười bước, G2, ba bản đồ, resume/change hoặc backend/Web đã chốt; native chuyển Future theo quyết định ngày 2026-09-17.

| Năng lực phải có trong bản đầu | Nội dung và ranh giới | Nơi thiết kế/kiểm chứng |
|---|---|---|
| Release đa thành phần | Một hồ sơ release liên kết đúng bản web/backend, dữ liệu và cấu hình; thứ tự triển khai, tương thích cũ–mới và phương án khi chỉ một phần thành công. Không đồng nhất merge/build/deploy/mở tính năng; không hứa mọi client Web cập nhật hoặc rollback nguyên tử. | R01-T07; R08-T04/T05; KA-28 |
...
### 1.2. Ma trận nền tảng — căn cứ và điều chỉnh hiện hành
...
Lịch sử vòng R2: Human xác nhận Windows và C++20/Ubuntu ở `R01-T03-S01-r1`; [bằng chứng](KIDEA_ROADMAP.md#r01-t03-s01-result). Hướng host và nơi build/chạy backend được thay đúng phần bằng approval local/đa nền tảng ngày 2026-09-16 dưới đây; không biến các kết quả Windows cũ thành bằng chứng macOS hoặc cấp quyền cài đặt.

<a id="local-portability-approved"></a>

#### Hợp đồng local/đa nền tảng — đã duyệt ngày 2026-09-16

Human đồng ý toàn bộ đề xuất sau [answer tại f8b47b9](https://github.com/Kynderis/kidea/blob/f8b47b9/answer.md), yêu cầu “support thật tốt thư mục local”, không có nhu cầu thư mục mạng/iCloud/OneDrive hoặc nhiều máy cùng ghi, và giao rà/triển khai trọn gói. [Gói triển khai hữu hạn](proposals/local-portability-r1.md) theo dõi phần sửa/kiểm; approval này không là nghiệm thu Mac chưa chạy hoặc quyền cài/build/deploy/cloud.

- Một bộ code, định dạng hồ sơ và giao diện lệnh dùng chung cho Windows, macOS Intel và Apple Silicon. Chỉ khác đường dẫn/công cụ và hành vi hệ thống file cần kiểm thực; không tách ba hệ thống writer, schema hoặc workflow. OS/CPU chỉ là thông tin môi trường, không tự là lý do khóa chức năng đọc/ghi thông thường. Khả năng của Xcode, Docker hoặc ứng dụng AI ngoài Kidea được kiểm riêng.
- Node.js **24 trở lên** là mức tối thiểu; khuyến nghị bản LTS còn được bảo trì. Không khóa đúng patch hoặc hash binary lúc chạy; ghi phiên bản/OS/CPU thực trong bằng chứng. Minor/patch tương thích không cần xin Human lại từng lần; major chưa kiểm phải nêu chưa kiểm, chỉ chặn khi thiếu API/không tương thích hoặc có ràng buộc an toàn thực. Không hứa mọi phiên bản tương lai đã được kiểm. Dependency vẫn có lockfile; xác minh nguồn tải khi cài không phải bắt mọi máy dùng một binary.
- Chỉ cây local độc lập, một lượt hợp tác có quyền ghi; từ chối đường mạng/đồng bộ hoặc đích không xác minh được trong phạm vi kiểm tra. Không tuyên bố phát hiện mọi phần mềm đồng bộ tùy ý: điều kiện vận hành là Human không đặt project trong cây đó. Giữ kiểm root/đích thực, liên kết/hard link, tên nhập nhằng hoa–thường/Unicode, quyền, CREATE-no-overwrite, pending và bản trước/đọc lại. File đang bận, hết đĩa hoặc lỗi ghi phải báo thiếu/chưa hoàn tất, không làm dữ liệu sai thành thành công.
- Git dùng công cụ đã được xác định trên host theo quyền project, không cố định đường dẫn Windows; gọi bằng tham số có cấu trúc, không chèn chuỗi đường dẫn vào shell. Đối chiếu CRLF/LF và đúng byte khi dùng Git làm bản trước; không coi checkout cùng commit là chắc chắn cùng byte. Không tự cài Git, sửa PATH, chuyển root hoặc xử lý đồng thời nhiều writer.
- Kết quả Windows trước đây giữ nguyên phạm vi. Kiểm branch/mô phỏng nền khác hỗ trợ phát hiện lỗi nhưng không chứng nhận filesystem/CPU/macOS thật; khi chưa có lượt Mac thực thì ghi `NOT_RUN`. Việc chuyển máy không đổi rule nghiệp vụ R03–R04 hoặc giảm G1–G6.

<a id="docker-local-cloud"></a>

#### Backend Docker local, cloud theo quyền — đã duyệt ngày 2026-09-16

Backend pilot C++20 giữ Ubuntu userspace làm nền ứng dụng; Docker local là nơi build/chạy/kiểm chức năng thường ngày. Một Dockerfile và chỉ thêm Compose nếu cần phối hợp backend/web/proxy; không yêu cầu thêm một Ubuntu VM do Human tự quản lý hoặc xây remote orchestrator. Đây là lựa chọn của backend đang làm, không áp container cho mọi sản phẩm của Kidea.

Docker Desktop trên Windows/macOS vẫn cần lớp Linux và dùng RAM/đĩa. Khi tới chuẩn bị môi trường, trình một gói máy/phiên bản/dung lượng/cache/giới hạn tài nguyên; ưu tiên dữ liệu Docker trên D ở Windows khi công cụ cho phép, không tự dọn C hoặc cài ở lượt sửa Kidea này. Intel local ưu tiên `amd64`, Apple Silicon ưu tiên `arm64` nếu dependency hỗ trợ; gói đưa cloud build/test đúng kiến trúc đích. Không lấy hiệu năng giả lập khác kiến trúc làm số đo máy chủ.

SQLite dùng volume bền vững ngoài vòng đời container; volume không phải backup. Giữ lifecycle/drain, transaction/result/audit/outbox, quyền/epoch, RPO/RTO, ca lỗi và mọi ngưỡng R04. Backup/observer trong container khác trên cùng laptop không chứng minh chống mất laptop/ổ đĩa; bài kiểm mất host và cảnh báo độc lập vẫn cần nơi độc lập khi tới lượt. Không thuê hạ tầng ngay để soạn/code.

Human sẽ cấp máy cloud khi cần test nặng/đo performance. Chỉ sau khi xác minh host/SSH/quyền/Docker, dữ liệu, lệnh/workload, thời hạn/chi phí/tải và điều kiện dừng, AI mới kết nối trong gói được giao. Dùng SSH/Docker và script project sẵn có, không tự xây dịch vụ điều phối từ xa. Ghi image/nguồn/config, kiến trúc, CPU/RAM/đĩa/giới hạn và kết quả; secret ngoài repo/log. Mất kết nối phải tra lại lần chạy trước retry, không tự replay. Chưa có host/credential/ngân sách được cấp trong approval này; quyền DEV/PROD vẫn theo G3.

| Thành phần | Hướng đã duyệt | Cấu hình nền đã duyệt để kiểm chứng | Môi trường thực thi dự kiến |
|---|---|---|---|
| Host Kidea | Windows, macOS Intel/Apple Silicon; một Human + AI, local | Một bộ helper Node ≥24; Windows có bằng chứng lịch sử, [Mac Intel đã kiểm lõi 283/283 trên cùng nguồn](tests/evidence/local-portability-mac-intel-2026-09-16.md), Apple Silicon NOT_RUN. Không khóa Node binary hoặc Git theo đường Windows | Cùng source/lệnh/hồ sơ; kiểm filesystem/runtime thực trước công bố hỗ trợ; Git theo quyền, không server Kidea hoặc sync/multi-writer |
| Backend sản phẩm | C++20 → Ubuntu userspace trong Docker | Ubuntu 24.04 LTS là baseline; GCC/G++ 13.3, CMake 3.28.3, Ninja là snapshot công cụ cần kiểm lại khi build. Local ưu tiên kiến trúc máy, release đúng kiến trúc đích; không mặc định modules/extension hoặc -march=native chưa kiểm | Build/test chức năng bằng Docker local; test nặng/performance trên cloud qua SSH/Docker khi Human cấp máy/quyền. Bằng chứng release trên đúng target/config, không lấy Windows/macOS native hoặc local giả lập thay đo máy chủ |
| Android — Future, chưa roadmap; cấu hình lịch sử | Kotlin + Jetpack Compose; native, code độc lập | Android Studio Quail 1 (2026.1.1) hoặc stable tương thích AGP 9.2.1; Gradle 9.4.1, JDK 17; Kotlin tích hợp của AGP (2.3.10), Compose compiler khớp Kotlin; Compose BOM 2026.06.01. compileSdk 37.0, targetSdk 37, minSdk 26 theo [amendment Android đã duyệt](proposals/r05-android-sdk37-r1.md); SDK Build Tools 36.0.0 | Gradle Wrapper trên host có toolchain tương thích được kiểm; không buộc host Kidea Windows. Một emulator khi cần và điện thoại thật để đo hiệu năng. Không thêm KMP/NDK mặc định; không áp lại kotlin-android plugin khi dùng Kotlin tích hợp của AGP 9 |
| iOS — Future, chưa roadmap; cấu hình lịch sử | Swift + SwiftUI; native, code độc lập; tận dụng Mac/iPhone hiện có | Khi đến bước iOS: ứng viên Xcode 26.6 + Swift compiler 6.3, Swift 6 language mode, iOS SDK 26.5; deployment target iOS 16.0 là nền đề xuất. Xcode này cần Tahoe 26.2–26.x | MacBook Pro 16 inch 2019 Intel, RAM 16 GB, hiện Sonoma và khoảng 512 GB trống; iPhone 12 Pro Max. Chỉ kiểm tra/nâng macOS nếu cần khi làm iOS; không cài/nâng ngay. UIKit/Metal chỉ bổ sung khi có nhu cầu và bằng chứng |
| Web | SvelteKit + TypeScript; prerender/SSR + realtime; SEO và hiệu năng xuyên suốt | Node.js 24 LTS (mốc 24.20.0), npm 11.19.0; SvelteKit 2.70.3, Svelte 5.57.0, TypeScript 6.0.3, Vite 8.2.2, vite-plugin-svelte 7.3.0, adapter-node 5.5.7. Đây là mốc tương thích metadata, chưa chạy build | Dev trên host có toolchain tương thích được kiểm; build/SSR trên Ubuntu theo cấu hình/kiến trúc đích, có thể cùng Compose khi cần. Nội dung prerender/assets qua CDN khi triển khai; không ghép Astro mặc định, không chuyển nghiệp vụ C++ sang Node |

**Lịch sử native — Future, không giao thực thi:** Android cập nhật ngày 2026-09-16 sau Human “Duyệt đổi SDK 37.0 và kiểm lại”; giữ lịch sử36.1/36 trong evidence A1. Chỉ SDK/target đổi, các rule và nghĩa vụ thiết bị không đổi. Kết quả thực theo [A1](tests/evidence/r05/android-execution-r1.md), không nhận approval baseline là runtime PASS.

**Ý nghĩa cấu hình nền (phần Android/iOS là lịch sử Future):** đây là tổ hợp đầu tiên để viết hướng dẫn và kiểm chứng Kidea, không phải giới hạn cố định cho mọi sản phẩm hoặc tuyên bố máy đã chạy được. Android 8/API 26 và iOS 16 là mức OS tối thiểu đề xuất cho tổ hợp này, không phải bằng chứng mượt trên mọi máy cũ; sản phẩm có nhu cầu khác phải chốt lại phạm vi ở đúng gate. Điện thoại là phạm vi kiểm chứng mobile đầu tiên; tablet/watch/TV/XR chưa được công bố hỗ trợ. Chưa chọn backend framework, database, CDN vendor hoặc thư viện đồ họa khi nghiệp vụ pilot chưa yêu cầu.

**Lịch sử trước quyết định Web-only; native hiện Future chưa roadmap:** từng project quyết định SDK/compiler/deployment target và ma trận thiết bị; Kidea đề xuất, ghi nhận và kiểm tương thích, không áp API26/iOS16 lên mọi project. Human đã giao dùng thiết bị mô phỏng trước để kiểm chứng Kidea theo [ma trận native R05](proposals/r05-simulator-lab-r1.md). Emulator/Simulator đủ làm môi trường cho ca đo được trong mẫu R05; điện thoại thật không là điều kiện vào tất cả các ca. Rule yêu cầu phần cứng/hiệu năng thực vẫn được đặc tả và giữ trong nghĩa vụ project tương ứng, không biến thành PASS mô phỏng. Bảng thiết bị bên dưới tiếp tục mô tả phạm vi ứng dụng/pilot; không yêu cầu nghiệm thu toàn ứng dụng ở R05. Cài/chạy tool mới vẫn cần gói môi trường cụ thể.

**Áp dụng ma trận hiện hành:** chỉ hàng Host Kidea, Backend và Web. Các hàng Android/iOS, minOS/SDK, store và thiết bị dưới đây lưu lịch sử Future, không yêu cầu cài hoặc kiểm để khép R05. Khi Human mở lại mới rà baseline và quyền tại thời điểm đó. Ma trận Web/viewport là lựa chọn của project; không áp thiết bị hoặc breakpoint chung.
...
- Runtime/helper của **Kidea** hiện theo [hợp đồng Node ≥24](#local-portability-approved); R02-T01-S01/S02 giữ lịch sử lựa chọn/cài thử Node 24.21.0, không còn khóa sử dụng. Chính sách cập nhật helper tương thích ở hợp đồng này là ngoại lệ rõ đối với yêu cầu review đổi major/host tổng quát phía trên; đổi semantics/quyền/gate vẫn review. Node trong dòng web là runtime **sản phẩm**, không tự quyết định hay đồng bộ phiên bản helper; không tự thay global/PATH.
...
|---|---|---|
| Host/file/Git | Cùng suite trên Windows/macOS Intel/Apple Silicon local: UTF-8, dấu/khoảng trắng, CRLF/LF, hoa–thường/Unicode, root/liên kết/quyền, CREATE/UPDATE/pending; checkout Git/conflict/approval cũ | Bằng chứng R02 cũ chỉ cho Windows/bản cũ. Gói local kiểm helper đang sửa, Mac thật chưa chạy; change/visualize và nghiệm thu R06/R09/R10 không tự hoàn tất |
| C++/Ubuntu | Build sạch Debug/Release bằng Docker local đúng Ubuntu userspace/toolchain/kiến trúc; unit/integration/sanitizer phù hợp; artifact release/performance kiểm đúng máy đích | Chưa cài/chạy Docker/build/cloud từ gói local. R05 vẫn có mẫu build nhỏ theo quyền; R08 chuẩn bị môi trường, R09 kiểm ứng dụng/restore/observer và đo tải khi đủ máy/quyền |
| Android — Future, chưa roadmap; cấu hình lịch sử | Emulator API 26 và API 36 để kiểm tra hành vi; máy thật hạng thấp khoảng 3–4 GB RAM, màn hình 60 Hz để đo release build; ghi model/OS/chip thực | Chưa có model Android được Human cung cấp; emulator không chứng minh hiệu năng máy yếu. Chọn thiết bị khi lập kế hoạch thử trước R09; nếu chưa có thì mục hiệu năng là chưa kiểm chứng, không PASS. Chưa xác minh SDK/JDK/ảo hóa/GPU |
| iOS — Future, chưa roadmap; cấu hình lịch sử | iPhone 12 Pro Max hiện có và simulator OS tối thiểu khi runtime khả dụng; release build, unit/UI/integration và đo frame/bộ nhớ/pin trên máy thật | Chưa kiểm tra phiên bản iOS/Xcode/Mac thực, signing hoặc simulator. Nếu không có môi trường cho iOS tối thiểu thì nêu thiếu và bổ sung thiết bị hoặc xin đổi phạm vi; iPhone hiện có không đại diện mọi máy yếu |
...
| Cài công cụ backend/Web | Dùng môi trường đã được cấp; không tự đổi global | Chỉ xin thêm khi thực sự thiếu công cụ; SDK/JDK/Android Studio Future |
| Native Future: nâng macOS/Xcode/signing | Dừng chuẩn bị/cài/chạy; giữ bằng chứng lịch sử | Chỉ xem lại khi Human mở lại scope, chưa roadmap |
...
- Backend C++ trên Ubuntu sở hữu rule và dữ liệu có thẩm quyền. Web SvelteKit + TypeScript theo ma trận đã duyệt; lớp SSR không sở hữu bản rule nghiệp vụ thứ hai. Android/iOS và hai màn N1/N2 là Future chưa roadmap, không nằm trong MVP hiện hành. Admin và monitoring chỉ trên web.
...
- Ngân sách phát sinh đã duyệt: **0 đồng**; tận dụng thiết bị/tài nguyên sẵn có nếu được phép. Không coi tài nguyên đang có là đã được kiểm tra hoặc đã cấp quyền dùng. Nếu thiếu tài nguyên Ubuntu, browser hoặc quyền/kết nối cần cho scope backend/Web, ghi blocker và xin quyết định; không ghi PASS. Native đã hoãn theo quyết định phạm vi, không là blocker hiện hành.
...
Tinh gọn nghĩa là mỗi file, trường dữ liệu, rule và kiểm tra có công dụng rõ, một nơi định nghĩa có hiệu lực. Chỉ tạo tài liệu/template/subtask khi có nội dung hoặc đầu ra độc lập; việc đủ nhỏ được làm trực tiếp. Mười bước là mười nhóm đầu ra cần xét, không phải mười bộ biểu mẫu phải sinh đầy đủ. Mạnh mẽ là kiểm chứng được và tiếp tục có căn cứ khi bị ngắt, không cố chống mọi môi trường ngoài phạm vi.
...
| 4. Trải nghiệm sản phẩm | Web và browser/viewport do project chọn; native Future; hành trình sử dụng, màn hình, dữ liệu và thao tác; trạng thái đang tải/rỗng/lỗi/thiếu quyền; phác thảo giao diện, yêu cầu khả năng sử dụng và test liên quan. Human duyệt thiết kế SEO (cấu trúc nội dung, URL, liên kết, metadata) trước kiến trúc khi áp dụng. |
...
Mỗi thời điểm có một đợt phát triển hiện hành và một mục công việc đang làm. AI có thể đọc/review nhiều file liên quan, nhưng mọi công cụ sửa nguồn cùng project được tuần tự hóa trong một lượt Kidea hợp tác. Dấu bận cấp project ngăn hai lượt Kidea hợp tác chạy chồng trên cùng cây; không là khóa phân tán qua máy hoặc rào bảo vệ khỏi writer ngoài luồng. Khi chuyển cửa sổ/máy phải kết thúc hoặc đối chiếu lượt cũ trước.
...
Chỉnh format, đặt tên trường, thêm fixture/test theo đặc tả hoặc code trong thiết kế/quyền đã cấp không tự phát sinh gate mới. Chỉ trình quyết định thực sự về phạm vi/hành vi, quyền/chi phí, chất lượng hoặc kiến trúc đáng kể. Nếu chưa nằm trong gate đã chốt, dừng đúng nhánh phụ thuộc để Human quyết định; không thêm lượt duyệt vì chia subtask hoặc tự bỏ Human gate.
...
**D1 hiện hành — Giữ đúng bản trình, ưu tiên Git; chỉ snapshot khi cần.** [Approval tinh gọn ngày 2026-09-14](#lean-operation-approved) thay yêu cầu luôn sao chép bản trình của S01-r1. Ưu tiên commit Git cố định đọc được tại local, có tham chiếu giữ lại không di chuyển/xóa khi còn cần, đã đối chiếu raw byte và độ dài/SHA-256 với nội dung lúc trình. Không dùng branch, HEAD, trạng thái sạch hoặc byte bị filter/newline đổi làm bằng chứng tương đương. Chưa có bản Git phù hợp thì snapshot byte tối thiểu đúng file cần thiết; không ép commit từng lần ghi hoặc chụp toàn repo. Ghi đường nguồn, phạm vi/anchor và revision. Lịch sử review không là nguồn đặc tả thứ hai, có vòng đời giữ riêng với payload phục hồi tạm.

Không sao chép secret/dữ liệu riêng tư vào hồ sơ/Git. File lớn, nhạy cảm hoặc bằng chứng ngoài repo phải có nơi giữ bản được phép và tham chiếu truy lại được; thiếu thì dừng phần phụ thuộc, không tự upload. Git chỉ thay snapshot khi giữ đúng byte và khả năng truy lại; nội dung chưa có trong Git cần snapshot. Chuyển máy phải chuyển đủ object/tham chiếu giữ lại hoặc snapshot trong quyền; thiếu bản thì chưa xác nhận. Bản local không chống hỏng ổ hoặc giữ việc chưa lưu.
...
Tại thời điểm S01-r1, manifest/schema/ghi còn chưa chọn; phần lịch sử này không là giới hạn hiện hành. Hợp đồng schema 2 và [mô hình ghi tinh gọn](#lean-operation-approved) bên dưới là căn cứ cho triển khai tiếp.
...
Human “Ok, Tôi duyệt cả 2 nhé” ngày 2026-09-13 sau [gói tại 24a3b61](https://github.com/Kynderis/kidea/blob/24a3b61a66d7024b6480aeeb7ca74a23f85a0222/answer.md) và giải thích Git/bản chưa commit/cleanup; [bằng chứng](KIDEA_ROADMAP.md#r02-t04-s02-result). Đây là căn cứ lịch sử. [Approval 2026-09-14](#lean-operation-approved) cập nhật Git-first và không tự replay/restore sau ngắt; không mở quyền phục hồi khác hoặc nhận nhiều file đổi nguyên khối.
...
**Git-first, không sao chép trùng:** ưu tiên đúng bản ngay trước thao tác trong Git local, đọc raw byte khớp và có tham chiếu giữ lại; không lấy branch/HEAD hoặc trạng thái sạch thay đối chiếu. Nội dung sửa chưa commit hoặc khác do filter/newline cần snapshot tối thiểu. Không bắt commit trước mỗi lần ghi. Mất bản thì dừng, không đoán/reset. Theo [approval tinh gọn](#lean-operation-approved), cách này áp dụng cả bản trước thao tác và bản trình review, nhưng vòng đời giữ riêng: cleanup phục hồi tạm không xóa căn cứ review.
...
Bản lịch sử Human duyệt, mốc phục hồi còn cần và evidence kết quả không là bản tạm được xóa vì task DONE. Giữ dấu vết lượt ghi/kết quả, ghi rõ payload đã dọn; không nhận bản đã xóa vẫn khả dụng. Git-first không cấp quyền xóa commit/tag/lịch sử. Giữ thử lỗi ghi/ngắt tiến trình trong mô hình hợp tác; phát hiện thay đổi ngoài luồng thì dừng, không cam kết ngăn mọi can thiệp đồng thời. Không bảo đảm mất điện/hỏng ổ hoặc việc chưa lưu/chưa chuyển máy.
...
| Một phần đúng bản trước, một phần đúng bản dự định | Giữ lượt chưa hoàn tất và file thực tế; báo phần đã/chưa xác nhận. Không tự replay/restore sau ngắt; chỉ sửa tiếp bằng phương án đã đối chiếu và có quyền rõ. |
...
**Không tự replay/restore sau gián đoạn.** G4 theo [approval mới](#lean-operation-approved): giữ nguyên trạng, đọc lại bản trước/dự định/thực tế, báo việc dở và xin hướng xử lý nếu cần sửa tiếp/khôi phục. Hash khớp hoặc dấu bận cũ không tự cấp quyền hoàn tác. Quyền dọn payload không cấp quyền xóa nguồn CREATE dở, reset Git, hoàn tác commit đã chia sẻ, replay deploy/migration hay restore database; tác dụng ngoài file phải tra bằng chứng thực, không chạy lại để dò.

Bộ mẫu/bằng chứng S03/S04 cũ giữ theo bản đã thử. Kiểm chứng mới có Git đúng/sai byte/không truy được, snapshot tối thiểu, ngắt trước/giữa/sau ghi, dấu bận và cleanup. Không còn yêu cầu chứng minh Win32 ngăn editor sửa/xóa/đổi tên; không sửa protocol hoặc PASS/FAIL cũ để chứng nhận mô hình mới.
...
| GitLocation | `kind: GIT`, `commit: Text`, `path: Text` | Commit cố định trong repo, path tương đối hợp lệ; raw byte đọc được và khớp integrity. Có tham chiếu local giữ lại không di chuyển/xóa khi còn cần. Dùng được cho review và bản trước thao tác theo Git-first; không dùng branch/tag động làm nhận diện, không cấp quyền Git hoặc bảo đảm đã chuyển bản sang máy khác. |
...
- Review hiện hành theo work.reviewRefs trong `.kidea/reviews/`; căn cứ lịch sử ưu tiên GitLocation đúng byte và được giữ lại. Chỉ snapshot khi cần dưới `.kidea/reviews/evidence/`. Không ghép ID/tên bên ngoài trực tiếp thành đường dẫn; Ref chỉ đích đã xác minh root/quyền. Bằng chứng review không dùng vòng đời cleanup của lượt ghi.
...
<a id="lean-operation-approved"></a>

#### Mô hình một lượt sửa và Git-first — đã duyệt ngày 2026-09-14

Human **“Tôi đồng ý hướng bạn đề xuất”** trong hội thoại ngày 2026-09-14, sau rà soát tổng quan–chi tiết về việc tinh gọn cho một người dùng. Xác nhận này duyệt hướng thay cơ chế/điều phối dưới đây và triển khai writer cùng kiểm thử xác định trên dữ liệu tổng hợp; không phải nghiệm thu kết quả chưa chạy, quyền project thật/pilot/production hoặc quota AI mới. [Trạng thái và công việc](KIDEA_ROADMAP.md#lean-core-review).

**Điều kiện sử dụng:** một Human, một lượt Kidea có quyền sửa trên cùng project ở mọi cửa sổ/máy. Human chờ xong; mọi chỉnh sửa nguồn đi qua Kidea. Helper, formatter, build sinh source, Git và agent có quyền ghi chạy tuần tự; không có editor/writer ngoài luồng hoặc đồng bộ chủ động đang sửa cây nguồn. Dấu bận cấp project chỉ từ chối lượt Kidea hợp tác chạy chồng; không là khóa phân tán, không ngăn chương trình khác bỏ qua quy ước. Cây local độc lập trên Windows/macOS theo [hợp đồng hiện hành](#local-portability-approved), không bắt NTFS/Windows theo tên; đường liên kết/reparse/hard link nhiều tên hoặc đích không xác minh được bị từ chối. Thư mục mạng/iCloud/OneDrive và nhiều máy cùng ghi ngoài phạm vi, không cam kết làm sau. Không tự chuyển project, tắt sync, đổi ACL hoặc cài VM.

**Ghi gọn nhưng có căn cứ:**

1. Xác minh root/đích thật, quyền và phạm vi; kiểm tra dữ liệu/đồ thị đầu vào, giữ một dấu bận cho lượt hợp tác. Nếu đã bận hoặc còn lượt chưa đối chiếu thì dừng, không tự phá dấu hoặc chạy chồng.
2. Với UPDATE, giữ **đúng byte ngay trước thao tác**: ưu tiên commit Git local đã đối chiếu và có tham chiếu giữ lại; nếu chưa có bản đó, Git filter/newline làm khác byte hoặc không thể giữ/truy bản, dùng snapshot tối thiểu của đúng file. CREATE xác minh đích vắng mặt và tạo mới không ghi đè; đích xuất hiện thì dừng, không chuyển thành UPDATE.
3. Trước sửa nguồn, lưu hồ sơ lượt nhỏ: đích, bản trước/dự định, đầu vào/quyền cần thiết và phần đã/chưa đọc lại. Hồ sơ dùng phát hiện ghi dở, không là trạng thái task/gate thứ hai. Dấu pending phải được phát hiện dù work.checkpointRef chưa cập nhật hoặc record bị ngắt.
4. Thay tuần tự các đích rồi đọc lại byte và kiểm tra quan hệ. Có lỗi/thiếu/mismatch thì dừng phần còn lại, giữ căn cứ và báo chưa hoàn tất. `COMPLETED_BYTES` chỉ xác nhận lớp byte/quan hệ của lượt, không là DONE/APPROVED hoặc nghiệm thu toàn lõi.
5. Sau gián đoạn, status/resume đọc thực tế để phân biệt BEFORE/PLANNED/OTHER/UNKNOWN; không tự replay, restore hoặc xóa nguồn CREATE dở. Chỉ xử lý tiếp khi phương án/quyền hiện hành rõ; dấu bận cũ hoặc hash khớp không tự cấp quyền.
6. Cleanup chỉ dọn payload tạm do lượt sở hữu, đúng allowlist/quyền, khi việc và kiểm tra bắt buộc đã hoàn tất, không còn pending hoặc tham chiếu/nhu cầu phục hồi. Đọc lại kết quả dọn, giữ lỗi và receipt cần thiết; không dọn bằng chứng review, Git ref/object còn cần hoặc nguồn sản phẩm. Vòng đời lưu review tách khỏi phục hồi tạm.

**Giới hạn được thay rõ:** không còn cam kết dùng khóa Windows để ngăn editor/tiến trình khác sửa/lưu/xóa/đổi tên thông thường, không yêu cầu worker Win32 hoặc proof/FINALIZE dưới handle liên tục. Phát hiện nguồn/đích đổi vẫn phải dừng, nhưng đối chiếu trước/sau không bảo đảm phát hiện kịp mọi can thiệp đồng thời ngoài mô hình. Không bảo đảm nhiều file đổi nguyên khối, mất điện/hỏng ổ hoặc phục hồi dữ liệu chưa lưu/chưa chuyển máy. Giới hạn này không cho chủ động ghi ngoài quyền, bỏ CREATE-no-overwrite, che lỗi hoặc giảm tính đúng của sản phẩm nhiều người/request.

Giữ schema 2 và các trường VersionRef/checkpoint có sẵn khi đủ biểu diễn; không thêm framework giao dịch, scheduler, graph database hoặc hệ thống backup riêng. Chi tiết code/bài thử ở bản triển khai và bằng chứng mới; kết quả native trước đó không chứng minh writer mới.

S04 đã triển khai Node writer/caller và kiểm thử xác định **174/174** trên bản nguồn giữ nguyên trong lượt; [bằng chứng mới](tests/evidence/r02-t06-cooperative.md). Chốt hiện bao một operation helper/init, không tự kiểm soát mọi lệnh shell của AI. Git đọc theo quyền riêng, không khởi tạo repo hoặc dò repo cha; không có thay đổi schema hồ sơ hay phục hồi tự động. Đây chưa là nghiệm thu hành vi AI/toàn lõi.

<a id="safe-write-namespace-review"></a>

#### Lịch sử r1/r2 — không còn là mô hình ghi hiện hành

R1 được duyệt sau [giải thích bd52a52](https://github.com/Kynderis/kidea/blob/bd52a5244dd7d2697fddea823807297ac046a166/answer.md); r2 được duyệt bằng “Ok nhé” sau [answer 5466a42](https://github.com/Kynderis/kidea/blob/5466a4230e5edafe243aca0bad2d0a95e1596f48/answer.md). R1/r2 yêu cầu khóa Win32 và r2 chỉ loại hai can thiệp liên kết đồng thời; mô hình đó được thay bằng hợp đồng một lượt hợp tác phía trên.

Giữ [probe 7 PASS/4 FAIL](tests/r02-t06/native-lock-evidence.md), [bằng chứng T06](tests/evidence/r02-t06.md), source manifest và protocol/fixture cũ đúng bản. Không đổi FAIL thành PASS/N/A hoặc sửa kỳ vọng cũ để chứng nhận writer mới. Bản native từng chỉ ghi với SNAPSHOT là kết quả lịch sử, không còn hạn chế thiết kế Git-first. Sự cố launcher/ACL vẫn [chưa giải quyết riêng](tests/r02-t07/launcher-preflight.md); approval tinh gọn không tự khôi phục ACL, mở sandbox hoặc nới quyền máy.
...
**Kiểm tra/build:** dùng bộ lệnh chuẩn của project và lưu kết quả thực, kể cả fail/skip/thiếu bằng chứng; AI thực hiện review ngữ nghĩa và Human gate riêng. Local là nơi điều khiển; backend dùng [Docker local/cloud theo quyền](#docker-local-cloud), không bắt thêm Ubuntu VM riêng. Container Ubuntu userspace đáp ứng môi trường ứng dụng cho kiểm chức năng, không tự thay bằng chứng máy đích về hiệu năng/release/restore; Web cần ma trận browser/viewport và điều kiện đo của project. iOS là Future chưa roadmap. Các bài cần dev chạy sau deploy; lượt cuối toàn dự án sau mỗi Feature theo G2 vẫn đầy đủ. Sau này dùng CI khi nhu cầu thực chứng minh cần, tái dùng bộ lệnh và giữ nghĩa điều kiện kiểm chứng; không mặc định phải có dịch vụ đó mới đúng quy trình.

**Triển khai:** một điểm vào deploy gọi các bước/script phụ cần thiết; DEV/PROD dùng chung cơ chế cho cùng loại thành phần, khác target/config/quyền. Backend và Web có thể có cơ chế triển khai riêng theo thành phần. Lệnh nhận đúng gói từng thành phần, cấu hình đích và phiên bản toàn bộ script/migration đã kiểm chứng; không tự lấy master mới nhất rồi build/deploy. Trước khi ghi, xác minh target thực, bản đang chạy, quyền, gói/config và điều kiện dữ liệu/phục hồi; tránh chạy chồng, ghi bước đã làm/chưa xác nhận, dừng khi lỗi. Sau deploy đọc lại phiên bản/config, kiểm tra service/luồng chính và ghi bằng chứng thực. Mất kết nối phải đối chiếu trước retry; rollback ứng dụng không được giấu restore database có thể mất dữ liệu.
...
**Hợp đồng T07-S01 đã duyệt:** [R02-T07-S01-r1 và xác nhận](proposals/r02-t07-init-r1.md) cụ thể hóa init mới/cũ, template và bootstrap. D1 phân biệt bước bắt buộc duyệt nhưng chưa lập phiếu với mục không có gate riêng: STEP chưa hoàn tất có thể chưa có ID phiếu khi điều kiện hoàn tất và blocker ghi nghĩa vụ duyệt; thiếu phiếu không bao giờ đủ điều kiện hoàn thành dù các con đã DONE. Không đổi schema 2 hoặc ngữ nghĩa approval của T03. Triển khai/kiểm chứng thuộc S02; không coi approval thiết kế, mẫu T02 hoặc primitive T06 là init đã hoạt động.
...
Những chỗ chưa có giá trị nhưng được phép thiếu phải được giải thích trong nextAction hoặc blocker khi cản việc tiếp theo. Ví dụ chưa chọn version lúc mới lập ý tưởng là hợp lệ; thiếu scopeRef hoặc không biết việc nào đang được thao tác không được chữa thành chuỗi rỗng/null mặc định. Không tạo placeholder file/review để làm link có vẻ hợp lệ; nhóm xa chưa có kế hoạch chi tiết vẫn có scopeRef/completionRef ở mức đầu ra đã xác định và nhãn chưa phân rã. LEAF ghi DONE phải có resultRefs không rỗng và đáp ứng completionRef cùng gate bắt buộc; kiểm tra sự tồn tại của các link chưa chứng minh các điều kiện đó đạt. gateIds rỗng hợp lệ khi mục không có gate riêng theo kế hoạch đã chốt; ngoại lệ [T07-S01-r1 đã duyệt](proposals/r02-t07-init-r1.md) cho STEP chưa hoàn tất khi chưa lập phiếu, có nghĩa vụ Human review trong completionRef và blocker của chính bước. Không suy danh sách rỗng thành miễn gate: STEP thiếu gate không hoàn tất dù đã phân rã đủ và các con DONE. Không áp ngoại lệ để bỏ gate phase/task hoặc LEAF DONE.
...
Mặc định `master` và một thư mục làm việc hiện có. Commit các phần việc mạch lạc đã kiểm tra đúng loại, không commit từng lần ghi; commit không tự là approval hoặc release. Branch/worktree/stash chỉ dùng khi có nhu cầu thật như giữ việc dở hoặc vá đúng bản production, trong quyền project. Stash là lưu tạm, không mặc định là backup/bằng chứng review hay dữ liệu đã chuyển máy. Worktree cùng repo không mở nhiều lượt sửa; nhận diện đúng nền khi đổi, tính cả dependency/artifact và dung lượng.
...
Phạm vi browser hiện hành của HTML offline Kidea: **Chrome**, theo [quyết định Human ngày2026-09-17](docs/R07_CHROME_SCOPE.md). Safari không thuộc phạm vi này. Ma trận Web của từng ứng dụng ở profile sản phẩm giữ riêng; bằng chứng host Windows/Mac Intel/Apple Silicon không suy từ nhau.
...
**Phục hồi lỗi ghi local:** theo [mô hình tinh gọn đã duyệt](#lean-operation-approved), sau gián đoạn giữ file hiện có, đọc lại bản trước/dự định/thực tế và báo phần dở; không tự replay/restore, xóa CREATE dở hoặc reset Git. Khi cần sửa tiếp/khôi phục, phải có phương án đúng bản/phạm vi/quyền được chấp nhận và kiểm tra trước/sau. Git-first giữ đúng bản ngay trước, snapshot tối thiểu khi Git không đủ; bản review có vòng đời riêng. Quyền sửa file không mở migration/database hay môi trường ngoài repo.

Ví dụ đang làm chức năng hủy: backend đạt, giao diện chưa xong thì lưu file và điểm tiếp tục, không nhận cả Feature DONE. Nếu lượt ghi bị ngắt giữa hai file, báo file nào đã/chưa khớp dự định và giữ căn cứ trước; không tự chép bản cũ trở lại chỉ vì còn backup.

G4 không xây hệ thống backup riêng. Kiểm chứng cơ chế cụ thể theo mô hình một lượt hợp tác ở R02; không nhận chống mất điện/hỏng ổ hoặc khôi phục được việc chưa chuyển máy. Không cấp quyền pilot hay thay G2, ngưỡng QUALITY và giới hạn production.
...
- Mỗi lần build cần nhận diện riêng, gắn bản nguồn và dấu nhận diện nội dung gói; version hiển thị không thay bằng chứng đúng artifact. Biến thể version/build number native là Future; khi được mở lại cần quy định nền tảng được kiểm tra tại profile; không ép một chuỗi vào mọi trường hoặc tự chọn số chưa kiểm tra. Giữ nguyên gói đã phát hành; không thay nội dung dưới cùng nhận diện gói.
...
Đây là chính sách nhận diện, không cấp quyền tạo/push tag hoặc production. Cơ chế/định dạng hồ sơ và phép kiểm tra backend/Web cụ thể còn thuộc R02/R05/R08; biến thể native Future chưa roadmap; hồ sơ release theo [G6](#release-records), ngưỡng QUALITY không đổi.
...
**R09 A–E (2026-09-17):** Human duyệt toàn gói tại77f5caf, gồm nghiệm thu D1. B bổ sung trong cùng `resume`: [sửa kế hoạch/round](.agents/skills/kidea/references/work-cycle.md), [release/attempt/observation](.agents/skills/kidea/references/delivery-records.md) và [phục hồi metadata được chọn rõ](.agents/skills/kidea/references/recovery.md). Giữ schema2/sáu action; không executor sản phẩm, quyền môi trường hoặc approval tự sinh. B đã qua [hồi quy nguồn cuối](tests/evidence/r09/ae-r1.md), không tự nghiệm thu từ approval kế hoạch. C đã chuẩn bị/Git local/public init/SAVE pilot; ứng dụng vẫn NOT_RUN. D/E là chính sách nghiệp vụ và lab áp đúng thời điểm trong [gói](proposals/r09-next-decisions-r1.md), không mở native hoặc bỏ gate tồn đọng đã hoãn.
...
Đây là công nghệ của helper, không đổi backend C++ hoặc công nghệ Web của sản phẩm; native Future chưa roadmap. Một skill vẫn gồm hướng dẫn và helper có tác dụng xác định; helper không tự duyệt nghiệp vụ hoặc chứng minh mọi dependency. **Lịch sử R02-T01-S02:** một nguồn tại `.agents/skills/kidea/`, Node 24.21.0 Windows x64 riêng trong `.tools/node-v24.21.0-win-x64/`, quyền tạo/thử khung và lưu bằng chứng; không cài global/PATH. Bộ Node đó vẫn có thể dùng kiểm hồi quy, không là bản bắt buộc cho mọi người/mọi máy. PyYAML 6.0.3 tại S03-r1 chỉ cho công cụ kiểm tra, đặt riêng `.tools/skill-validation/`, không là dependency runtime Kidea. [Kết quả khung lịch sử](KIDEA_ROADMAP.md#r02-t01-scaffold-result) không tự là nghiệm thu đa nền tảng hoặc mọi KA; không sửa bằng chứng cũ thành kết quả bản mới.
...
Yêu cầu Human: Kidea có sẵn hướng dẫn lập trình phù hợp từng ngôn ngữ và nơi chạy code, dùng cho backend/Web; mobile Future chưa roadmap; chú trọng hiệu năng, quản lý bộ nhớ/tài nguyên và môi trường đích.
...
| Thành phần/môi trường | Backend, Web; mobile Future chưa roadmap; compiler/runtime/framework, hệ điều hành, CPU/thiết bị hỗ trợ, thư viện, cấu hình build và giới hạn tài nguyên. |
...
Ma trận giữ Ubuntu 24.04 LTS userspace, nay [Docker local/cloud theo quyền](#docker-local-cloud); toolchain và kiến trúc artifact phải ghi rõ, local ưu tiên kiến trúc máy và release đúng đích. Xem [ma trận](#platform-matrix) để tránh duy trì cấu hình thứ hai. Workload, thư viện/cấu hình thực và khả năng chạy trên máy đích vẫn cần kiểm chứng, không suy từ tên Ubuntu hoặc Docker. Ví dụ với GCC trên x86, `-march=native` lấy đặc điểm CPU máy build và có thể sinh chương trình không chạy trên CPU máy khác; không được mặc định bật chỉ vì cùng dùng Ubuntu. [GCC — x86 Options](https://gcc.gnu.org/onlinedocs/gcc/x86-Options.html).
...
Với Web, giữ cùng cơ chế nhưng thay tiêu chí theo nơi chạy: browser/viewport do project chọn, thời gian tải/phản hồi, tính đúng của state UI, khả năng sử dụng, lifecycle, mạng và quản lý tài nguyên. Mobile là Future chưa roadmap. Không áp nguyên xi tối ưu của backend vào UI.
...
Trạng thái tiếp nối: [R05 đã được Human nghiệm thu backend/Web](docs/R05_ACCEPTANCE.md). [Gói R06 r1](proposals/r06-maps-change-r1.md) đã APPROVED D1–D7 và phần local ngày2026-09-17; đã được [Human nghiệm thu R06 r1](docs/R06_ACCEPTANCE.md) tại nguồn `4b365d4`. [Gói R07 offline r1](proposals/r07-offline-view-r1.md) APPROVED D1–D5, đã có [kết quả Chrome](tests/evidence/r07/implementation-r1.md). [R07 đã được Human nghiệm thu](docs/R07_ACCEPTANCE.md) tại `94dc339`; lượt dựng/đo view trên pilot thật vẫn NOT_RUN, chuyển sang gate bắt buộc R09-T14. [Gói R08 r1](proposals/r08-delivery-r1.md) đã APPROVED D1–D3; [hướng dẫn bước9–10](.agents/skills/kidea/references/delivery.md) áp dụng các nguyên tắc G2/G3/G5/G6 có sẵn, không thêm executor/schema. [Kết quả r1](tests/evidence/r08/implementation-r1.md) chỉ kiểm local/hồ sơ; lab R2 và nghiệm thu R08 còn mở. Giữ schema2; map/assessment là bằng chứng, plan là hàng đợi duy nhất. Canh3lượt không tiến triển/20đánh giá chỉ thuộc fixture và2phiên mới×15phút chỉ thuộc gói này; không mở ngưỡng sản phẩm rộng hoặc quyền Docker/cài đặt.
