...
Android cập nhật ngày 2026-09-16 sau Human “Duyệt đổi SDK 37.0 và kiểm lại”; giữ lịch sử36.1/36 trong evidence A1. Chỉ SDK/target đổi, các rule và nghĩa vụ thiết bị không đổi. Kết quả thực theo [A1](tests/evidence/r05/android-execution-r1.md), không nhận approval baseline là runtime PASS.
...
**Kiểm tra/build:** dùng bộ lệnh chuẩn của project và lưu kết quả thực, kể cả fail/skip/thiếu bằng chứng; AI thực hiện review ngữ nghĩa và Human gate riêng. Local là nơi điều khiển; backend dùng [Docker local/cloud theo quyền](#docker-local-cloud), không bắt thêm Ubuntu VM riêng. Container Ubuntu userspace đáp ứng môi trường ứng dụng cho kiểm chức năng, không tự thay bằng chứng máy đích về hiệu năng/release/restore; iOS vẫn cần Mac/toolchain và thiết bị bắt buộc trong ma trận. Các bài cần dev chạy sau deploy; lượt cuối toàn dự án sau mỗi Feature theo G2 vẫn đầy đủ. Sau này dùng CI khi nhu cầu thực chứng minh cần, tái dùng bộ lệnh và giữ nghĩa điều kiện kiểm chứng; không mặc định phải có dịch vụ đó mới đúng quy trình.
