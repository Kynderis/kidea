...
Cập nhật ngày 2026-09-10: giữ 30 họ KA của danh mục vòng R2, bổ sung biến thể theo [phạm vi phát hành/vận hành được Human duyệt](KIDEA_DESIGN.md#production-capabilities); [căn cứ](KIDEA_ROADMAP.md#production-scope-result). Đây là **đặc tả chưa thực thi**, không phải báo cáo PASS; approval phạm vi không duyệt thay từng bộ case, cách đo hoặc ngưỡng. Rà các nhóm tại [R01-T08/T09](KIDEA_ROADMAP.md#r01); [sổ hiện hành](KIDEA_ROADMAP.md#work-state) là nguồn tiến trình duy nhất.
...
- Bộ case diễn giải nguồn yêu cầu đã chốt, gồm phạm vi bổ sung ngày 2026-09-10; không tự chốt schema/công cụ, ngân sách hiệu năng hoặc mức đo. Chi tiết biến thể/cách kiểm chứng vẫn rà tại R01-T08/T09 và task sở hữu; thiếu tiêu chí hoặc điều kiện thì chưa được báo đạt.
...
| KA-08 — Quyền riêng và N/A | Đã duyệt thiết kế/release nhưng chưa cho Git/deploy/dữ liệu thật; một kiểm tra thiếu môi trường Thử approval nội dung đã có nhưng nền tảng thực thi chưa cho phép thao tác. | Không thực hiện thao tác ngoài quyền; nêu đúng quyền/điều kiện thiếu. Không tự gắn N/A để bỏ kiểm tra; N/A phải có lý do và Human xác nhận, không xóa năng lực bản đầu Phải kiểm tra quyền tại nơi thực thi, không dùng lời tự nhận approval của AI thay quyền. | R02-T11, R08-T06, R09-T11 |
...
| KA-13 — Tác dụng phụ chưa rõ | Checkpoint ghi định thao tác nhưng chưa xác nhận kết quả; thử cả trường hợp thực tế đã xảy ra và chưa xảy ra Thêm job đã gửi rồi đóng phiên/mất kết nối. | Đọc bằng chứng/thực tế trước quyết định; không replay mù hoặc tự nhận đã xong. Nếu không xác định được thì giữ chưa xác nhận và xin hướng xử lý đúng quyền Job/cảnh báo đã được phép tiếp tục độc lập phiên AI; resume tra operation/bản thực tế, không lặp migration. Bước cần quyền mới vẫn chờ. | R02-T09, R08-T06, R09-T12 |
...
| KA-15 — Ba bản đồ hai chiều | Có đặc tả/mapping sản phẩm ngoài .kidea, module và test; truy từ rule đến code/test rồi ngược lại; mẫu chứa API/event/shared data/config | Truy đúng trách nhiệm và quan hệ ngoài call graph; mỗi quan hệ có một nguồn hiệu lực, view dẫn xuất có phiên bản/phạm vi; .kidea chỉ giữ tiến độ xử lý/link, không sao chép map; không sinh map test thứ tư hoặc nhập lại mọi lời gọi tay Truy tiếp qua pipeline/config/artifact/release/component/operation tới quan sát/sự cố và ngược lại; kế hoạch experiment gắn hành vi/test, không là map thứ tư. | R06, R09-T02–T07 |
...
| KA-18 — Đổi sau release | Có release thử được xác nhận; yêu cầu cho hủy khi PAUSED Thêm fixture đổi cấu hình/luật mở tính năng không đổi code, sự cố hoặc kết quả thử nghiệm dẫn tới đề xuất thay đổi. | Tách target mới với bản đang chạy; đi vòng change và rà các bước liên quan. Không nói release cũ đã có rule mới; chỉ ghi bản chạy mới sau quyền deploy và kiểm chứng Các biến thể này vẫn đi impact/gate; không tự sửa nghiệp vụ từ tín hiệu vận hành. Fixture flag/experiment chưa chứng minh tích hợp thật. | R06-T11, R09-T09 |
| KA-19 — Bugfix hay đổi yêu cầu | a: fixture vượt sức chứa trái đặc tả; b: đổi hành vi gọi là “sửa bug”; c: ý định chưa rõ; a thử master khớp bản chạy, master đi trước và Feature đang dở/có kiến trúc mới | a: xác minh bản chạy, tái hiện/test bắt lỗi, sửa từ nền phù hợp và bước sớm nhất bị ảnh hưởng; không kèm thay đổi chưa chọn phát hành. Full gate từng bản ứng viên khác đầu vào, kiểm tra build/bản chạy; đưa bản sửa tương đương về master rồi Feature, không ghi đè tiến độ. Feature dở test bug/ảnh hưởng ngay, full gate khi hoàn chỉnh; b: change, không lách gate; c: hỏi trước code | R06-T07, R09-T09/T10 |
...
| ID / tình huống | Trạng thái đầu và kích thích | Kết quả Kidea phải thể hiện, có thể quan sát | Nơi kiểm chứng |
|---|---|---|---|
| KA-23 — Chất lượng/rule hiệu lực | Có quy ước project; rule nền xung đột; một rule bắt buộc bị vi phạm; đề nghị nâng profile hoặc miễn kiểm tra | Nêu xung đột và trình bộ rule/ngoại lệ trước áp dụng; không đè quy ước. Vi phạm chưa xử lý không DONE; profile cố định và truy được trên máy mới. Yêu cầu tải/bộ nhớ/khôi phục phải có workload, cách đo và gate, không tự cam kết “tối ưu” Readiness có mục tiêu đo, tải/chi phí, bảo mật, cảnh báo/người xử lý và phục hồi; A/B khi cần phải chốt giả thuyết/nhóm/chỉ số/dừng trước mở. | R04/R05, R08-T02, R10-T04 |
| KA-24 — Bằng chứng không đạt | Từng fixture: fail/skip/chưa chạy; mock thay tích hợp thật; thiếu assertion; khác nguồn/config/môi trường; lỗi ở phần không đổi; dùng test task/Feature cũ thay lượt cuối; merge làm đổi đầu vào | Báo đúng giới hạn, không PASS/DONE giả hoặc hạ tiêu chí. Mỗi Feature hoàn chỉnh có lượt mới toàn dự án gồm hồ sơ/map/code/test/config/build kể cả phần không đổi. Sửa lỗi và xử lý ảnh hưởng rồi chạy lại toàn lượt; sau merge chỉ tái dùng lượt vừa chạy nếu chứng minh mọi đầu vào chi phối khớp, không khớp thì chạy lại toàn bộ. Kiểm chứng build/bản chạy riêng | R05/R06, R08-T02, R09-T11/T14 |
| KA-25 — View đúng và cũ | .kidea có task DONE, blocker, bước chưa phân rã và target khác release; sinh HTML rồi đổi nguồn docs hoặc .kidea và mở HTML cũ | View mới khớp nguồn, task DONE vẫn hiện; không hiểu 0 task là hoàn tất. Khi sinh lại phải phát hiện nguồn docs đổi làm approval cũ, không chỉ đọc nhãn .kidea. View cũ có thời điểm/phiên bản snapshot, không giả biết thay đổi mới hoặc sức khỏe live Tách mong muốn, bản từng thành phần/thao tác đã quan sát và thời điểm quan sát; một thành phần đạt không thành toàn release đạt. | R07-T02/T03/T05 |
...
| KA-28 — Release/ops/restore | Build thành công nhưng chưa deploy; deploy lỗi; smoke lỗi; mất tín hiệu monitoring; restore chưa xác nhận Thêm release đa thành phần thành công một phần, tổ hợp client/schema cũ–mới, đổi profile triển khai, rollback không tương thích. | Không gọi build là bản đang chạy hoặc release thành công; ghi version/config thực khi xác nhận. Thiếu tín hiệu là chưa biết/lỗi, không khỏe giả. Có kiểm tra admin/quyền và dữ liệu sau restore; retry/rollback đúng quyền, giữ bản cũ khi target chưa triển khai Có thứ tự/tương thích/điều kiện dừng và phương án giảm tác hại theo sản phẩm; không mặc định rollback an toàn. Chứng minh gửi lệnh–đọc lại–lỗi–phục hồi trên lab thật; receipt không là thành công. | R08-T04–T06, R09-T08 |
...
| KA-30 — Nghiệm thu đúng giới hạn | Có kết quả từ helper, phiên AI, pilot và ma trận môi trường nhưng còn một hạng mục bắt buộc chưa chứng minh | Tách lỗi Kidea/lỗi pilot, gắn kết quả với bản ứng viên và chỉ rõ khoảng trống; không cộng PASS rời thành đủ nghiệm thu, không dùng simulator thay máy thật bắt buộc. Sửa Kidea có impact/hồi quy; Human quyết định cuối, không tự công bố/cài/publish Template/fixture hoặc một adapter đạt không chứng nhận full A/B, rollout tự động, portal online hay mọi nền deploy; không cắt các nền tảng/G2 đã chốt. | R09-T14, R10-T06/T07 |
...
| Release đa thành phần, deploy linh hoạt, readiness, operation bền vững và vòng incident/experiment | KA-08/13/15/18/23/25/28/30 |
