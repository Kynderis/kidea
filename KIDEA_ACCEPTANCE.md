...
Gói `P01-T04-ACCEPTANCE-r2`, ngày 2026-09-07: đồng bộ ranh giới `PROJECT-FILES-r1` đã duyệt, giữ 30 họ kịch bản. Đây là **đặc tả kịch bản, chưa thực thi**; không phải báo cáo PASS. Trạng thái xây dựng duy nhất nằm ở [roadmap](KIDEA_ROADMAP.md#p01-t04-result). Bộ này được tổng hợp vào gate cuối P01; ngưỡng chất lượng và mức bằng chứng tối thiểu còn chốt ở P01-T05 [H].
...
Ranh giới thử: `.kidea` là hồ sơ điều phối/review; `docs/` hoặc vị trí nguồn của project là tài liệu sản phẩm; source/test/config ở vị trí chuẩn, cùng một repo. Case phải kiểm tra link, phiên bản và quyền qua các vùng này, không giả định mọi hồ sơ đều nằm dưới `.kidea`. Bản r2 chỉ bổ sung đối chiếu ranh giới đã duyệt, không duyệt chính sách Git G1–G6 hoặc các đề xuất mới từ rà soát tổng quan.
...
| ID / tình huống | Trạng thái đầu và kích thích | Kết quả Kidea phải thể hiện, có thể quan sát | Nơi kiểm chứng |
|---|---|---|---|
| KA-09 — Dữ liệu sai | Từng fixture: thiếu file bắt buộc trong .kidea hoặc docs; trùng ID; link xuyên thư mục đứt/sai root; trạng thái trái nhau; nhiều task hiện hành; schema không hỗ trợ | Chỉ rõ vị trí và loại thiếu/sai; không tự coi DONE, init đè hoặc sao chép rule vào .kidea để lấp thiếu. Dừng phần phụ thuộc, giữ nguồn để đối chiếu; thiếu mapping không thành không ảnh hưởng; link ngoài vùng được phép không cấp quyền ghi | P02/P03, P07, P11-T06 |
| KA-10 — Ghi lỗi/gián đoạn | Trên bản sao có docs và .kidea, gây lỗi quyền ghi; ngắt giữa cập nhật nhiều file; nguồn sản phẩm hoặc record review đổi sau khi đọc | Không báo cập nhật thành công khi chưa đủ; không mất nội dung không thuộc quyền ghi. Phát hiện trạng thái dở/mâu thuẫn, có đường khôi phục theo hợp đồng P02 trước tiếp tục; không áp kết quả đọc cũ lên nguồn mới âm thầm. So cả nguồn sản phẩm lẫn hồ sơ điều phối, không chỉ .kidea | P02-T04, P03, P12-T03 |
...
| KA-15 — Ba bản đồ hai chiều | Có đặc tả/mapping sản phẩm ngoài .kidea, module và test; truy từ rule đến code/test rồi ngược lại; mẫu chứa API/event/shared data/config | Truy đúng trách nhiệm và quan hệ ngoài call graph; mỗi quan hệ có một nguồn hiệu lực, view dẫn xuất có phiên bản/phạm vi; .kidea chỉ giữ tiến độ xử lý/link, không sao chép map; không sinh map test thứ tư hoặc nhập lại mọi lời gọi tay | P07, P11-T02 |
