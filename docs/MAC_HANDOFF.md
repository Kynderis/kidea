...
**Điểm tiếp tục hiện hành R08:** D1–D3 r1 đã được Human duyệt trên `8f04649`; đã có [hướng dẫn/kiểm local](../tests/evidence/r08/implementation-r1.md), chờ Human nhận kết quả. R08 IN_PROGRESS, không khép bằng review hồ sơ. [R2-A](../proposals/r08-lab-r2-execution-r1.md) đã có inventory Docker chỉ đọc + script/manifest theo lượt Human giao sau `34aa641`; [báo cáo chuẩn bị](../tests/evidence/r08/lab-r2-preparation.md), chờ duyệt execution. Chưa chạy service/container mới, AI trial hoặc sửa pilot. R1 trước đó không Docker. Các trạng thái chờ D1–D3 dưới đây là lịch sử.
