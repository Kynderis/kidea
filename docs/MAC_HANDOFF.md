...
**Điểm tiếp tục hiện hành R08:** D1–D3 r1 đã được Human duyệt trên `8f04649`; đã có [hướng dẫn/kiểm local](../tests/evidence/r08/implementation-r1.md), chờ Human nhận kết quả. R08 IN_PROGRESS, không khép bằng review hồ sơ. [R2-A](../proposals/r08-lab-r2-execution-r1.md) đã được Human duyệt trên `d245799`; [15/15 vector lab PASS_SCOPED](../tests/evidence/r08/lab-r2-execution-r1.md),6container đều dừng. Một lượt manifest đã dùng; không tự chạy lại. Human chọn Docker local, chưa có server. [B1](../proposals/r08-product-build-r1.md) đã chuẩn bị nguồn/cache/script, chờ duyệt build + R08-TIDY-01; [B2](../proposals/r08-local-delivery-ops-r1.md) chờ artifact B1 trước khóa execution. [Báo cáo](../tests/evidence/r08/product-preparation-r1.md). Chưa chứng minh profile sản phẩm hoặc host/observer độc lập. Không sửa pilot, không AI trial. R1 trước đó không Docker. Các trạng thái chờ D1–D3 dưới đây là lịch sử.
