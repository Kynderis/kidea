...
**R08 hiện hành (2026-09-17):** [B2](../tests/evidence/r08/b2-execution-r1.md), [G2 cuối](../tests/evidence/r08/final-r1.md) và [cloud độc lập](../tests/evidence/r08/cloud-execution-r1.md) PASS_SCOPED. [Gói nghiệm thu](R08_ACCEPTANCE.md) REVIEW_READY_PENDING_HUMAN; phần triển khai/kiểm hoàn tất, còn đúng Human nhận kết quả. R08 vẫn IN_PROGRESS, chưa tự mở R09/R10. Giữ mọi FAIL và bằng chứng Windows/pilot. Không cần cài công cụ hoặc xin lại quyền kỹ thuật.
...
**Điểm tiếp tục hiện hành R08:** chờ Human nghiệm thu [R08-T01–T06](R08_ACCEPTANCE.md). Core283/C++48/Web32+4/Chromium18 và6mutation đạt; B2 hai target đạt; cloud mất VM/disk thật, observer giữ backup/cảnh báo, VM mới restore56record/bảng rồi job tăng65. [Review nguồn/bằng chứng](../tests/evidence/r08/final-r1/review.json), [bảo toàn cuối](../tests/evidence/r08/final-r1/preservation-final.json). Mọi manifest B1/B2/cloud đã dùng; không rerun output cũ, dùng lại ngoại lệ tidy hoặc reset deadline. R09 pilot/R09-T14 NOT_RUN bắt buộc; không sửa/init live pilot hoặc chạy AI trial. Các điểm tiếp tục cũ dưới đây là lịch sử.
